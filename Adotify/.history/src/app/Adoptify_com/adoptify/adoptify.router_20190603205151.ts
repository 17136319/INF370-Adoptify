...
const adoptifyRoutes: Routes = [
    ...
    //fostercare
    { path: 'addfostercareparent', component: VolunteerComponent },
    { path: 'maintainfostercareparent', component: MainainvolunteerComponent },
    { path: 'searchfostercareparent', component: SearchvolunteerComponent},
