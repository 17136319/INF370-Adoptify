...
const adoptifyRoutes: Routes = [
    ...
    { path: 'maintaindonation', component: AddDonationComponent},
    { path: 'searchdonation', component: AddDonationComponent},
    ...
    // Event
    { path: 'addevent', component: AddAnimalComponent},
    { path: 'searchevent', component: SearchanimalComponent},
    { path: 'maintainevent', component: ViewanimalComponent },
    { path: 'addeventtype', component: AddanimaltypeComponent},
    { path: 'searcheventtype', component: SearchanimaltypeComponent},
    { path: 'maintaineventtype', component: MaintainanimaltypeComponent },
    // animal
    ...
    //kennel
    { path: 'addkennel', component: AddfostercareparentComponent },
    { path: 'maintainkennel', component: MaintainfostercareparentComponent },
    { path: 'searchkennel', component: SearchfostercareparentComponent},
    { path: 'addtokennel', component: AddFosterCareComponent },
    { path: 'removetokennel', component: RemoveFosterCareComponent },
    // volunteer
