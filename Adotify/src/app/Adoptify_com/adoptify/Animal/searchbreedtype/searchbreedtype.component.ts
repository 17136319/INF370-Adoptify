...
const ELEMENT_DATA: PeriodicElement[] = [
  {position: 1, name: 'Money',description: '',animaltype: 'Cat'},
  {position: 2, name: 'Accesory',description: '',animaltype: 'Dog'},
  {position: 3, name: 'Money',description: '',animaltype: 'Cat'},
  {position: 4, name: 'Accesory',description: '',animaltype: 'Dog'},
];
